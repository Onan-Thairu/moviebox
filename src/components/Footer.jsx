function Footer() {
  return (
    <div>
      <div className="flex justify-between mt-20 mb-6 w-[40%] m-auto sm:w-[20%] sm:mb-8 sm:mt-40">
      ...
      <div className="flex justify-between gap-2 w-[90%] m-auto text-xs font-semibold mb-6 sm:w-[50%] sm:mb-8">
